...
function Membership(){
    return(
        <div className="Membership-Container">
            ...
            <div className="Alumni-Memb">
                <h2 >Alumni Membership</h2>
                <p>Consequat ex nulla quis consectetur. Culpa do cupidatat consequat anim id est. Amet dolore veniam aliqua ipsum deserunt. Exercitation nulla occaecat in laboris labore deserunt veniam minim duis ad irure velit commodo culpa. Dolore excepteur officia laborum non nostrud commodo mollit ut. Veniam tempor commodo amet incididunt esse eiusmod.</p>
            </div>
            <div className="Special-Memb">
